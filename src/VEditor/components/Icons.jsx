...
export const Bold = ({ size = 20, color = "none", className = "" }) => (
...
export const Italic = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export const Underline = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.995 3.744v7.5a6 6 0 1 1-12 0v-7.5m-2.25 16.502h16.5" />
    </svg>
);

export const Code = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75 22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3-4.5 16.5" />
    </svg>
);

export const ListBullet = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
    </svg>
);

export const ListNumbered = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export const Link = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
    </svg>
);

export const Image = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
    </svg>
);

export const Table = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
export const Bars3 = ({ size = 20, color = "none", className = "" }) => (
    <svg fill={color} width={size} height={size} className={className} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
